// See docs/superpowers/specs/2026-05-23-lich-v1-design.md (section 4).
...
export interface ProfileDef {
  ...
  env_from?: EnvFrom;
  /**
   * Same shape as {@link TopLevelLifecycle}. Composition with top-level:
   * `before_up`/`after_up` run top-level then profile; `before_down` runs
   * profile then top-level (LIFO).
   */
