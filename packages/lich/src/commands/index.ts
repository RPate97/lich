...
// `exitCode` overrides the default 0/1 mapping; keep `ok` consistent (ok=false when exitCode!==0).
...
const execHandler: CommandHandler = async (ctx) => {
  ...
  // Forward the specific exit code (2/127/130/child's own code) verbatim.
