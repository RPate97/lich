...
export const BUILTIN_SUMMARIES: Record<string, string> = {
  ...
  feedback:
    "Send the lich team feedback (auto-attaches version, OS, redacted yaml).",
};
...
export const BUILTIN_LONG_HELP: Record<string, string> = {
  ...
  feedback: [
    "Usage: lich feedback [message] [--file PATH] [--no-context] [--no-browser] [--yes]",
    "",
    ...
    "anything. Cached locally at ~/.lich/feedback/<timestamp>.md. On",
    "confirmation, opens a pre-filled GitHub issue in the default browser",
    "for short payloads; long payloads print a curl command and a deep-link",
    "without the body (paste the cached payload yourself).",
    "",
    "Flags:",
