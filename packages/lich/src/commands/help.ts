...
export const BUILTIN_LONG_HELP: Record<string, string> = {
  ...
  exec: [
    ...
    "",
    "Run an ad-hoc command with the resolved env loaded. Defaults to the",
    "built-in `stack` env_group. Inherits stdio.",
    "",
  ...
  env: [
    ...
    "emitted in sorted order; values are quoted as needed.",
    "",
