...
export interface StackSnapshot {
  ...
  /** Profile this stack was started under, when one was active. */
  active_profile?: string;
}

/** Resolve `<LICH_HOME>/stacks/<stack-id>/state.json`. */
...
/** Poll state.json until `status` matches one of `expected`. Throws on timeout. */
